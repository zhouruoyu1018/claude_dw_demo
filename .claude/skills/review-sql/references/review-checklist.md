...
**正例**:
```sql
CREATE TABLE ph_sac_dmm.dmm_sac_loan_prod_daily (...)    -- dm 层，放款主题，产品+日粒度
CREATE TABLE ph_sac_da.da_sac_overdue_analysis (...)     -- da 层，逾期主题
```
...
INSERT INTO ph_sac_da.da_sac_overdue_report ...
```
