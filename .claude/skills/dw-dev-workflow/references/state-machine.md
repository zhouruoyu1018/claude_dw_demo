...
> **重要**: 记忆读写的具体时机已内联到 SKILL.md 各 Phase 的 `☑️ 必做清单` 中，确保不被遗漏。以下为完整参考表。
...
每个 Phase 完成后，**自动更新 MEMORY.md**（对应 SKILL.md 必做清单中的步骤）：
...
| Phase 5 | 更新 req 文件 status: done | `docs/wip/req-{table_name}.md` |
